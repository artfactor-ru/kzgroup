...
function ajaxSearch() {
        ...
        $.each(json, function (index, element) {
          $("#search_result")
            ...
            .append(
              '<a href="' +
                element.URL +
                '" class="live-search__item no-barba"><span class="live-search__item-inner"><span class="live-search__item-name"><span class="live-search__item-hl">' +
                element.TITLE +
                '</span><p style="color:#999;">' +
                element.DATE_CHANGE +
                "</p></a>"
            );
  ...
  $(document).ready(function () {
    ...
    $(".vac-d-form-test2").on("click", function () {
      $(".vac-d-form2").hide(200), $(".share_wrap").fadeOut(200);
    }),
  ...
  if (id) {
    if (
      ...
      !document
        ...
        .classList.contains("tabs-common-content") &&
      !document
        .querySelector(window.location.hash)
        .classList.contains("press-news-in-main-text")
    ) {
    ...
    if (link[i].href == pathSplit) {
      ...
      if (current) {
        ...
        if (text != "ВСЕ") {
          ...
          title.innerHTML =
            textTitle +
            '<div class="title--inner-main title--inner-main--sub press-header-title" style="opacity: 1; transform: translate(0px, 0%); display:block;">' +
            text +
            "</div>";
        }
      }
...
function yearSelection() {
  ...
  if (yearSelect) {
    let containerYearScroll = document.querySelector(
      ".press-dropdown-list-content"
    );
    if (containerYearScroll) {
      scrollbarYear = ScrollbarSmoth.init(containerYearScroll, options2);
    }
    let dropdown = document.getElementById("myDropdown");
    let btnSelect = document.querySelector(
      ".press-rigt-side-bar-date-button-drop"
    );
    ...
    document.addEventListener("click", function (event) {
      if (
        !event.target.classList.contains("press-rigt-side-bar-date-button-drop")
      ) {
...
function headerShowAndHideDesktop() {
  ...
  if (scrollProgress > 50 && coordinateTwoScreenTop >= scrollProgress + 10) {
    ...
    scrollProgress <= 0 ||
    (scrollProgress > 100 && coordinateTwoScreenTop <= scrollProgress + 10)
  ) {
  ...
  if (coordinateTwoScreenTop >= scrollProgress + 10) {
    ...
    scrollProgress > 50 &&
    coordinateTwoScreenTop <= scrollProgress + 10
  ) {
  ...
  if (traktorsContainer) {
    if (
      scrollProgress > coordinateTraktorsWrapperTop &&
      scrollProgress < coordinateTraktorsWrapperBottom
    ) {
  ...
  if (museumContainer) {
    if (
      coordinateHeaderBottom + 120 > coordinateMuseumWrapperTop &&
      scrollProgress < coordinateMuseumWrapperBottom
    ) {
      header.classList.add("js-hide");
      header.classList.add("js-scroll-hide");
      header.classList.add("js-scroll-noshadow");
    } else if (
      coordinateHeaderBottom < coordinateMuseumWrapperTop ||
      scrollProgress > coordinateMuseumWrapperBottom
    ) {
      header.classList.remove("js-hide");
      header.classList.remove("js-scroll-hide");
...
function showNav(containerTop, containerBottom) {
  ...
  if (
    containerTop <= scrollProgress &&
    coordinateTraktorsNavBottom <= containerBottom
  ) {
  ...
  if (maps) {
    ...
    function init() {
      ...
      let place = new ymaps.Placemark(
        ...
        {
          iconImageHref:
            "/local/templates/kzgroup/img/contacts/ya_maps_pin.svg",
          iconImageSize: [64, 64],
...
function stickyNav(navigation) {
  ...
  if (
    coordinateMuseumWrapperTop <= scrollProgress &&
    coordinateMuseumWrapperBottom - navHeight + 50 >= scrollProgress
  ) {
    nav.classList.add("show");
  } else {
    nav.classList.remove("show");
...
// Аккордеон
function accordion() {
  let accordionItem = document.querySelectorAll(
    ".accordion-item:not(.accordion-item--noinner)"
  );
    ...
    item
      ...
      .addEventListener("click", function (e) {
        ...
        if (active.length && active[0] !== item) {
          ...
          active[0].querySelector(".accordion-item-content").style.display =
            "none";
...
function eventOnScrollDesktop() {
  ...
  if (!isInternetExplorer()) {
    ...
    for (let i = 0; i < parallaxImgSlideCompanies.length; i++) {
      parallaxSlideCompanies(
        parallaxImgSlideCompanies[i],
        parallaxImgSlideCompanies[i].parentElement.parentElement.parentElement
          .parentElement
      );
    }
...
if (containerTablePurchaseScroll) {
  scrollbarTablePurchase = ScrollbarSmoth.init(
    containerTablePurchaseScroll,
    options6
  );
}
...
const enableSwiper = function () {
  ...
  if (document.querySelectorAll(".history__photos")) {
    document
      .querySelectorAll(".history__photos")
      .forEach(function (slider, index) {
        slider.classList.add("swiper-container--history-" + index);
        slider
          .querySelector(".swiper-scrollbar--history")
          .classList.add("swiper-scrollbar--history-" + index);
        swipersHistory[index] = new Swiper(
          ".swiper-container--history-" + index,
          {
            slidesPerView: "1",
            scrollbar: {
...
const enableSwiperForPress = function () {
  if (document.querySelectorAll(".press__container")) {
    document
      .querySelectorAll(".press__container")
      .forEach(function (slider, index) {
        slider.classList.add("swiper-container--press-" + index);
        slider
          .querySelector(".swiper-button-next")
          .classList.add("press_swiper-button-next-" + index);
        slider
          .querySelector(".swiper-button-prev")
          .classList.add("press_swiper-button-prev-" + index);
        slider
          .querySelector(".swiper-scrollbar--news")
          .classList.add("swiper-scrollbar--news-" + index);
...
const initSlider = function () {
  ...
  if (document.querySelector(".swiper-container--companies")) {
    ...
    swiperCompanies.on("slidePrevTransitionStart", function () {
      let btnCompanies = document.querySelectorAll(
        ".swiper-slide-active .button-more--inner"
      );
      ...
      gsap.utils
        .toArray(".swiper-slide-active .companies__title .title--inner")
        .forEach((element) => {
          gsap.fromTo(
            element,
            {
      ...
      gsap.utils
        .toArray(
          ".swiper-slide:not(.swiper-slide-active) .companies__title .title--inner"
        )
        .forEach((element) => {
          gsap.fromTo(
            element,
      ...
      gsap.utils
        .toArray(".swiper-slide-active .companies__desc")
        .forEach((element) => {
          gsap.fromTo(
            element,
            {
      ...
      gsap.utils
        .toArray(".swiper-slide-active .button-more--inner")
        .forEach((element) => {
          gsap.fromTo(
            element,
            {
  ...
  if (document.querySelector(".swiper-container--hero")) {
    ...
    swiperHero.on("slidePrevTransitionStart", function () {
      ...
      gsap.utils
        .toArray(".swiper-slide-active .hero__title .title--inner")
        .forEach((element) => {
          gsap.fromTo(
            element,
            {
      ...
      gsap.utils
        .toArray(".swiper-slide-active .hero__subtitle")
        .forEach((element) => {
          gsap.fromTo(
            element,
            {
  ...
  setTimeout(function () {
    if (document.querySelector(".swiper-container--gallery")) {
      ...
      for (let i = 0; i < gallerySlider.length; i++) {
        let galleryScroll = gallerySlider[i].querySelector(
        ...
        swiperGallery[i].on(
          "lazyImageReady",
          function (swiper, slideEl, imageEl) {
...
const breakpointCheckerForDesktopAndLower = function () {
  ...
  if (breakpointDesktop.matches === true) {
    ...
    parallaxImgSlide = document.querySelectorAll(
      ".main__hero .parallax__img--slide"
    );
    parallaxImgSlide2 = document.querySelectorAll(
      ".companies .parallax__img--slide"
    );

    parallaxImgSlideTwo = document.querySelectorAll(".parallax__img--two");
    parallaxImgSlideNews = document.querySelectorAll(
      ".news .parallax__img--slide"
    );

    let parallaxSlideCompWrap = document.querySelectorAll(
      ".container--news--eng"
    );
    parallaxImgSlideCompanies = document.querySelectorAll(
      ".container--news--eng .parallax__img--slide"
    );
    ...
    for (let i = 0; i < slidersPress.length; i++) {
      ...
      slidersPress[i]
        .querySelector(".swiper-wrapper--press")
    ...
    if (document.querySelector(".swiper-purchase")) {
      document
        .querySelector(".swiper-purchase")
        .classList.remove("swiper-container");
      document
        .querySelector(".swiper-wrapper--purchase")
        .classList.remove("swiper-wrapper");
...
const breakpointCheckerForDesktopAndLowerOnce = function () {
  // Все что выше десктопа 1280
  if (breakpointDesktop.matches === true) {
    btnMore = document.querySelectorAll(
      ".traktors__text-wrap--desktop .button-more--traktors"
    );
    // Меню в контактах
    ...
    if (traktorsContainer) {
      coordinateTraktorsWrapperBottom =
        getCoordsFrame(traktorsContainer).bottom;
    ...
    if (historyContainer) {
      coordinatehistoryContainerBottom =
        getCoordsFrame(historyContainer).bottom;
    ...
    btnMore = document.querySelectorAll(
      ".traktors__text-wrap--tablet .button-more--traktors"
    );
    // Меню в контактах
...
const breakpointCheckerForMobile = function () {
  ...
  if (breakpointMobile.matches === true) {
    ...
    if (document.querySelector(".statistics__slider")) {
      document
        .querySelector(".statistics__slider")
        .classList.remove("swiper-container");
      document
    ...
    for (let i = 0; i < slidersHistory.length; i++) {
      ...
      slidersHistory[i]
        .querySelector(".history__photos--container")
        .classList.remove("swiper-wrapper");
      let historySlides = slidersHistory[i].querySelectorAll(
    ...
    if (document.querySelector(".kirovets_tabs__container")) {
      ...
      for (let i = 0; i < InnerSliders.length; i++) {
        ...
        InnerSliders[i]
          .querySelector(".kirovets_tabs__features-list")
          .classList.remove("swiper-wrapper");
        let slides = InnerSliders[i].querySelectorAll(
          ".kirovets_tabs__features-item"
        );
        for (let i = 0; i < slides.length; i++) {
          slides[i].classList.remove("swiper-slide");
        }

        InnerSliders[i].removeEventListener(
          "mouseover",
          setMainSwiperMouseOver
        );
    ...
    if (document.querySelector(".history_slider")) {
      document
        .querySelector(".history_slider")
        .classList.remove("swiper-container");
      document
        .querySelector(".history_achieves--list")
        .classList.remove("swiper-wrapper");
      let achievesSlides = document.querySelectorAll(
        ".history_achieves--list-item"
      );
  ...
  let scrollMobile = function () {
    if (!ticking) {
      window.requestAnimationFrame(function () {
        ...
        // Прекратить автоплей у свайпера на главной странице если его не видно
        if (document.querySelector(".swiper-container--hero")) {
          let flagScrollHero = Visible(
            document.querySelector(".swiper-container--hero")
          );
          if (flagScrollHero) {
            swiperHero.autoplay.start();
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (videoMain) {
    ...
    let btnsPlaySlider = document.querySelector(
      ".button__video-controls--hero"
    );
    if (btnsPlaySlider) {
  ...
  if (
    ...
    !document.querySelector(".hero-common") &&
    !document.querySelector(".main__hero") &&
    !document.querySelector(".main--person")
  ) {
    header.classList.add("js-scroll-noshadow");
    ...
    $("#vac-form").submit(function (event) {
      ...
      if (number.val() === "") {
        ...
        if (number.next().is(".form-invalid-error") === false) {
          $(
            "<div class='form-invalid-error'>обязательное поле<div/>"
          ).insertAfter($(number));
          scrollToTopForm(number, 400);
          validPhone = false;
        } else if (
          number.next().is(".form-invalid-error") === true &&
          number.val() === ""
        ) {
          scrollToTopForm(number, 400);
        }
      ...
      if (name.val() === "") {
        ...
        if (name.next().is(".form-invalid-error") === false) {
          ...
          name.next().is(".form-invalid-error") === true &&
          name.val() === ""
        ) {
          scrollToTopForm(name, 1600);
        }
      ...
      if (secName.val() === "") {
        ...
        if (secName.next().is(".form-invalid-error") === false) {
          ...
          secName.next().is(".form-invalid-error") === true &&
          secName.val() === ""
        ) {
          scrollToTopForm(secName, 1700);
        }
  ...
  for (let i = 0; i < pin.length; i++) {
    ...
    pinLink.addEventListener("click", function (event) {
      ...
      if (popup.classList.contains("popup-hidden")) {
        ...
        swiperFrame.translateTo(
          -getCoordsFrame(popup).left + swiperFrame.getTranslate(),
          0,
          false,
          true
        );
...
function form() {
  $(".share_butt").on("click", function () {
    $(".share_wrap").fadeIn(), $(".vac-d-form2").show(300);
  }),
  ...
  $(".button--details__myzey").click(function () {
    ...
    $(".vacancies-d__form-wrapper--feedback__muzey .vacancies-d__form").show(
      300
    );
  });
  $(".vacancies-d__download").click(function () {
    ...
    $(
      ".vacancies-d__form-wrapper--feedback__vacanciessmall .vacancies-d__form"
    ).show(300);
  });

  $(".rent-details__button").click(function () {
    $(".vacancies-d__form-wrapper--feedback__activy").fadeIn();
    $(".vacancies-d__form-wrapper--feedback__activy .vacancies-d__form").show(
      300
    );
  });
  ...
  $(".jd-branch-style").on("click", function () {
    $(".rent-form__radio--style--nomatter").addClass(
      "rent-form__radio--style-none"
    );
  });
  $(".rent-form__radio-label").on("click", function () {
    $(".rent-form__radio--style--nomatter").removeClass(
      "rent-form__radio--style-none"
    );
  });
  ...
  addEducationBtn.on("click", function () {
    ...
    if (addEducationBtn.attr("data-click") === "0") {
      ...
      let closestBlock = addEducationBtn
        .closest(".add-education")
        .prev("." + copyBlockName);
      let copy = closestBlock.clone();
      copy.removeClass(copyBlockName);
      copyBlockName =
        copyBlockName.substring(0, copyBlockName.length - 1) + copyNumber;
      copy.addClass(copyBlockName);
  ...
  addWorkBtn.on("click", function () {
    ...
    if (addWorkBtn.attr("data-click") === "0") {
      ...
      let closestBlock = addWorkBtn
        .closest(".add-work")
        .prev("." + copyBlockNameWork);
      // console.log(closestBlock);
      let copy = closestBlock.clone();
      copy.removeClass(copyBlockNameWork);
      copyBlockNameWork =
        copyBlockNameWork.substring(0, copyBlockNameWork.length - 1) +
        copyNumber;
      copy.addClass(copyBlockNameWork);
    ...
    $(a).submit(function (e) {
      ...
      if (error === 0) {
        return $.ajax({
          ...
          data: self.serialize(),
          success: function () {
            $(".vacancies-d__form-wrapper--feedback__muzey").css(
              "display",
              "none"
            );
...
jQuery(function ($) {
  ...
  newsImg.after(function () {
    ...
    if (imgTitle)
      return (
        '<div class="press-news-in-main-photo-description">' +
        imgTitle +
        "</div>"
      );
  });
